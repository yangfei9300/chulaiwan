<template>
	<view>
		<view class=" colonn" :class="{
			'topview1':vipType==1,
			'topview':vipType==0,
		}">
			<view class="w-750 roww rowsa center_center color6_r" style="position: absolute;" :style="{
				...
				<!-- <view class="roww center_center allline" :style="{
				'line-height':jnSize.height+'px',
				}">会员中心</view> -->
				...
				<image class="w-50 h-50 m-right-24"
					src="https://ta.imjiayi.com/upload/upload/VIP_slices/左箭头.png"></image>
			</view>
		</view>

		<view class="colonn " style="margin-top: -350rpx;z-index: 1000;">
			<view class="roww p-left-30 p-right-30">
				...
				<view class="colonn">
					...
					<view class="gongxichenehuiy" v-if="!userInfo.is_vip||userInfo.is_vip==0">暂未开通VIP特权 </view>
			...
			<view class="roww pore w-690 h-269 m-left-30">
				...
				<image class="w-690 h-269   poab" v-if="vipType==1" style="top:0rpx;left:0rpx;"
					src="https://ta.imjiayi.com/upload/upload/黑钻VIP_slices/02 220202021@2x.png"></image>

				<view class="poab" v-if="vipType==0" style="top: 40rpx;right: 30rpx;z-index: 1000;color: #7B4800;">
					{{userInfo.vip_str}}</view>
				<view class="poab" v-else-if="vipType==1" style="top: 40rpx;right: 30rpx;z-index: 1000;color: #7B4800;">
					{{userInfo.svip_str}}</view>
					...
					<view class="jinqe" v-for="(item,index) in chongzhiList" :style="{
						...
						<view class="colonn center_center pore w-214 h-236">
							...
							<image class="w-170 h-36"
								src="https://ta.imjiayi.com/upload/upload/VIP_slices/13 6@2x.png"></image>
							<view class="lijians">
								立减{{item.money_}}元
							</view>
						</view>
			...
			<view class="colonn p-left-28" v-if="vipType==1">
				<view class="h-34"></view>
				<view class="zhuanshutequantxt">我的专属特权</view>
				<view class="h-28"></view>
				<view class="roww">
					<image src="https://ta.imjiayi.com/upload/upload/黑钻VIP_slices/17.png" class="w-76 h-76">
					</image>
					...
					<view class="colonn">
						...
						<view class="tqjieshi">平台保障，独特的算法体系，活动发布后， <span style="color: #7B4800;">精准
								匹配高质量玩家</span>，想你所想，懂你所需，<span style="color: #7B4800;">组局成 功率100%</span></view>
					</view>
				</view>
				...
				<view class="roww">
					<image src="https://ta.imjiayi.com/upload/upload/黑钻VIP_slices/15.png" class="w-76 h-76">
					</image>
					<view class="w-18"></view>
					<view class="colonn">
				...
				<view class="roww">
					<image src="https://ta.imjiayi.com/upload/upload/黑钻VIP_slices/16.png" class="w-76 h-76">
					</image>
					<view class="w-18"></view>
					<view class="colonn">
						<view class="tqtitle">活动展示</view>
						<view class="h-5"></view>
						<view class="tqjieshi">活动 <span style="color: #7B4800;">全平台置顶</span> ，在活动列表及首页活动推荐优 <span
								style="color: #7B4800;">先高亮展示</span> ，保证活动权重</view>
					</view>
				</view>
				<view class="h-50"></view>

				<view class="roww">
					<image src="https://ta.imjiayi.com/upload/upload/黑钻VIP_slices/14.png" class="w-76 h-76">
					</image>
					<view class="w-18"></view>
					<view class="colonn">
				...
				<view class="roww">
					<image src="https://ta.imjiayi.com/upload/upload/黑钻VIP_slices/18.png" class="w-76 h-76">
					</image>
					<view class="w-18"></view>
					<view class="colonn">
						<view class="tqtitle">身份标识</view>
						<view class="h-5"></view>
						<view class="tqjieshi">可获得 <span style="color: #7B4800;">黑金昵称与黑钻vip专属标识</span>，彰显尊贵身 份</view>
					</view>
				</view>
				<view class="h-50"></view>

				<view class="roww">
					<image src="https://ta.imjiayi.com/upload/upload/黑钻VIP_slices/19.png" class="w-76 h-76">
					</image>
					<view class="w-18"></view>
					<view class="colonn">
						<view class="tqtitle">专属福利</view>
						<view class="h-5"></view>
						<view class="tqjieshi">平台不定期组织黑钻vip <span style="color: #7B4800;">专属活动和福利</span></view>
					</view>
				</view>
			...
			<view class="colonn p-left-28" v-if="vipType==0">
				<view class="h-34"></view>
				<view class="zhuanshutequantxt">我的专属特权</view>
				<view class="h-28"></view>
				<view class="roww">
					...
					<view class="colonn">
						...
						<view class="h-5"></view>
						<view class="tqjieshi">发布/参加活动可获得<span style="color: #7B4800;">双倍金币及活跃度</span></view>
					</view>
				</view>
				<view class="h-50"></view>
				<view class="roww">
					...
					<view class="colonn">
						...
						<view class="h-5"></view>
						<view class="tqjieshi">会员用户<span style="color: #7B4800;">发起活动次数不限</span>，非会员每月仅可发布四场</view>
					</view>
					<view class="h-50"></view>
				</view>
				<view class="h-50"></view>
				<view class="roww">
					...
					<view class="colonn">
						...
						<view class="h-5"></view>
						<view class="tqjieshi">可获得金色昵称<span style="color: #7B4800;">与VIP标识，</span>会员活动在列表内<text
				...
				<view class="roww">
					...
					<view class="colonn">
						...
						<view class="h-5"></view>
						<view class="tqjieshi">线上畅聊，会员用户 <span style="color: #7B4800;">限次</span> 无say hello（非会 员仅限三句）
						</view>
					</view>
					<view class="h-50"></view>
				</view>
