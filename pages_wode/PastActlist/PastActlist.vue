	...
	<view class="content">
		...
		>
			...
			>
				...
				<image src="https://ta.imjiayi.com/upload/upload/发布活动_slices/箭头 下 (6).png" class="w-40 h-40 yincang1"></image>
			</view>
		</view>
		...
		<view style="margin-top: -490rpx">
			<view class="Past" v-for="(item, index) in list" :key="index" @click="NavDetail(item.id)">
				<image class="PastCover" :src="item.cover" mode="aspectFill"></image>
				<view class="PastRight colonn rowsb h-200">
					...
					<view class="PastRight_date roww">
						...
						<view class="TimeLink roww center_center">
							<image class="TimeImg" src="../../static/xin.png" mode=""></image>
