...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"chulaiwan11","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var runtime = __webpack_require__(/*! @babel/runtime/helpers/regeneratorRuntime */ 236)();
...
/* WEBPACK VAR INJECTION */(function(uni) {var env = __webpack_require__(/*! ./config.js */ 73); //配置文件，在这文件里配置你的OSS keyId和KeySecret,timeout:87600;

var base64 = __webpack_require__(/*! ./base64.js */ 74); //Base64,hmac,sha1,crypto相关算法
__webpack_require__(/*! ./hmac.js */ 75);
__webpack_require__(/*! ./sha1.js */ 77);
var Crypto = __webpack_require__(/*! ./crypto.js */ 76);
...
var uploadFile = function uploadFile(filePath, dir, successc, failc) {
  console.log("==oss组件=", filePath, dir, successc, failc);
...
var fileHost = 'https://jiayiwangluo.oss-cn-beijing.aliyuncs.com/'; //你的阿里云地址最后面跟上一个/   在你当前小程序的后台的uploadFile 合法域名也要配上这个域名
var config = {
  //aliyun OSS config
