	...
	<view style="overflow: hidden;">
		...
		<view class="box" :class="{
			...
			<view class="shop">
				<view class="shop_basic">
					<view class="" :style="{
						...
						<view class="shop_distance">距您当前位置<text>{{distance}}km</text></view>
					</view>
				...
				<view class="basic_scroll">
					<scroll-view class="scroll_view roww center_center" scroll-x="true">
						<view class="scroll_item" v-for="(Sitem,Sindex ) in list.site" :key="Sindex"
							...
							<view class="colonn center_center">
								...
								<image v-if="Sitem.headimg"
									...
									:src="Sitem.headimg" mode=""></image>
								<image v-else class="scroll_item_img" src="../static/wuren.png" mode=""></image>

								<!-- position: relative;top: -20rpx; -->
								<image class="scroll_item_img " style="width: 40rpx;height: 40rpx;margin-top:-30rpx;"
									v-if="Sitem.is_ready==1&&Sindex!=0"
									src="https://ta.imjiayi.com/upload/upload/Component 78@2x.png" mode="">
								</image>
								<view class="faqiren" v-if="Sindex==0" :style="{
									'color':nightMode?'white':'black'
								}">发起人</view>
			...
			<image v-else-if="list.in_team>0&&list.is_captain!=1"
				...
				style="position: fixed;left:24rpx;width:674rpx;height: 138rpx;bottom: 50rpx;z-index: 500000000;"
		...
		<view class='qihua' v-show='pay'>
			<view class="pbox">
				...
				<view class='ppayinfo'>
					<view>支付金额</view>
					<view class="pprice">￥{{list.money_}}</view>
